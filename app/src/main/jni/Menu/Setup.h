...
void Init(JNIEnv *env, jobject thiz, jobject ctx, jobject title, jobject subtitle){
    //Set sub title
    setText(env, title, OBFUSCATE("<b>CAKMODS X HGMOD</b>"));

    //Set sub title
    setText(env, subtitle, OBFUSCATE("<b><marquee><p style=\"font-size:33\">"
                                      "<p style=\"color:green;\">ㅤㅤㅤㅤㅤModded by Lan Anh |</p>"
                                      "<p style=\"color:green;\"> Hack Được Tạo Bởi CakMods X HGMOD © | Đây Là Phiên Bản Cân Tố Cáo Không Có Chức Năng Tuyển Thủ | Mua Key Hack Liên Hệ Admin t.me/LanAnhOwner | Youtube Cak Mods | Telegram Group: t.me/HGMOD_CS |</p>"
                                      "</marquee></b>"));
    ...
    //Toast Example
    Toast(env,ctx,OBFUSCATE("CAKMODS X HGMOD"),ToastLength::LENGTH_LONG);
